...
@register_model("caption_baseline")
class CaptionBaselineModel(TransformerModel):
    ...
    @staticmethod
    def add_args(parser):
        super(CaptionBaselineModel, CaptionBaselineModel).add_args(parser)
        parser.add_argument(
            "--pooler-dropout",
            type=float,
            metavar="D",
    ...
    def register_classification_head(
        ...
        self.classification_heads[name] = CaptionBaselineClassificationHead(
...
class CaptionBaselineClassificationHead(nn.Module):
...
@register_model_architecture("caption_baseline", "caption_baseline_large")
def caption_baseline_large_architecture(args):
    args.encoder_embed_path = getattr(args, "encoder_embed_path", None)  # todo: check embed_path_usage
...
@register_model_architecture("caption_baseline", "caption_baseline_base")
def caption_baseline_base_architecture(args):
    ...
    caption_baseline_large_architecture(args)